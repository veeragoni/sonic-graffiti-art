...
import html2canvasMin from './html2canvas.min';
    ...
    .then(canvas => {
        ...
        canvas.toBlob((blob) => {
            ...
            s3.putObject(params,function(err, data){
                ...
                let fileObjectUrl = "https://sonicgraffiti.s3.us-west-1.amazonaws.com/"+fileName; 
                const s3ObjectUrl = parseUrl(fileObjectUrl);
                ...
                presigner.presign(new HttpRequest(s3ObjectUrl)).then(function(value) {
                    let url = formatUrl(value);
                    axios.post('https://d11kfw4rdu3qd4.cloudfront.net/create'
                    ,{"long_url":url}, {headers:shortUrlHeaders})
                    .then((response)=>{
                        let tweetMessage = "https://twitter.com/intent/tweet?text=Check%20this%20out%20%23sonicgraffiti%20%23re%3aMARS2022%20%23amazontranscribe%20"+response.data.short_id;
                        ...
                        console.log("Error when generating short url:"+error);
                    })

                    

                }, function(error){
                    console.log("Error when generating presign url:"+error);
                });
